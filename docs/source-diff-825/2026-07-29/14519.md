...
@@ -69,26 +69,26 @@ if (empty($data['mallFavicon']) === false) {
...
@@ -106,14 +106,14 @@ if (empty($data['mallFavicon']) === false) {
         <tr>
             <th>상호(회사명)</th>
             <td class="form-inline">
...
@@ -128,17 +128,17 @@ if (empty($data['mallFavicon']) === false) {
         <tr>
             <th>대표자명</th>
             <td colspan="3" class="form-inline">
...
+                <input type="text" name="item" value="<?= $data['item']; ?>" <?= $readonly . $disabled; ?> class="form-control width-lg"/>
         ...
         <tr>
@@ -147,19 +147,19 @@ if (empty($data['mallFavicon']) === false) {
...
@@ -169,7 +169,7 @@ if (empty($data['mallFavicon']) === false) {
...
@@ -179,14 +179,14 @@ if (empty($data['mallFavicon']) === false) {
             <th>사업장 주소</th>
             <td colspan="3">
...
@@ -195,10 +195,10 @@ if (empty($data['mallFavicon']) === false) {
             <td colspan="3">
                 <div class="form-inline">
                     <label class="radio-inline">
...
@@ -208,12 +208,12 @@ if (empty($data['mallFavicon']) === false) {
...
+                                <input type="hidden" name="unstoringInfo[<?= $k ?>][mainFl]" value="<?= $data['unstoringInfo'][$k]['mainFl'] ?>"/>
                                 <table class="table table-cols" value="<?= $v['sno'] ?>">
                                     <colgroup>
                                         <col class="width-md"/>
@@ -260,13 +260,13 @@ if (empty($data['mallFavicon']) === false) {
             <td colspan="3" class="form-inline">
                 <div class="form-inline">
                     <label class="radio-inline">
...
@@ -276,12 +276,12 @@ if (empty($data['mallFavicon']) === false) {
...
+                                <input type="hidden" name="returnInfo[<?= $k ?>][mainFl]" value="<?= $data['returnInfo'][$k]['mainFl'] ?>"/>
                                 <table class="table table-cols" value="<?= $v['sno'] ?>">
                                     <colgroup>
                                         <col class="width-md"/>
@@ -326,23 +326,32 @@ if (empty($data['mallFavicon']) === false) {
         <tr>
             <th>대표전화</th>
             <td class="form-inline">
...
@@ -360,16 +369,16 @@ if (empty($data['mallFavicon']) === false) {
             <td colspan="3" class="form-inline">
                 <div class="form-inline">
                     <label class="radio-inline">
...
@@ -379,7 +388,7 @@ if (empty($data['mallFavicon']) === false) {
...
@@ -415,7 +424,7 @@ if (empty($data['mallFavicon']) === false) {
...
+                    <input type="text" name="centerPhone" value="<?= $data['centerPhone']; ?>" maxlength="12" class="form-control js-number-only width-md"/>
                 ...
                 <div>
                     <?php
@@ -423,7 +432,7 @@ if (empty($data['mallFavicon']) === false) {
...
+                    <input type="text" name="centerSubPhone" value="<?= $data['centerSubPhone']; ?>" maxlength="15" class="form-control js-number-only width-md"/>
             ...
             <th>팩스번호</th>
@@ -433,7 +442,7 @@ if (empty($data['mallFavicon']) === false) {
...
+                <input type="text" name="centerFax" value="<?= $data['centerFax']; ?>" maxlength="15" class="form-control js-number-only width-md"/>
         ...
         <tr>
@@ -441,18 +450,18 @@ if (empty($data['mallFavicon']) === false) {
             <td colspan="3" class="form-inline">
                 <div class="form-inline">
                     <label class="radio-inline">
...
@@ -460,7 +469,7 @@ if (empty($data['mallFavicon']) === false) {
         <tr>
             <th>운영시간</th>
             <td colspan="3" class="form-inline">
...
@@ -476,7 +485,7 @@ if (empty($data['mallFavicon']) === false) {
         <tr>
             <th>회사소개 내용</th>
             <td class="form-inline">
...
@@ -489,10 +498,10 @@ if (empty($data['mallFavicon']) === false) {
...
@@ -529,12 +538,12 @@ if (empty($data['mallFavicon']) === false) {
             }
         });
...
@@ -613,9 +622,9 @@ if (empty($data['mallFavicon']) === false) {
...
@@ -756,7 +756,7 @@ class BuyerInform extends \Component\AbstractComponent
