...
@@ -43,6 +43,9 @@ use Framework\Utility\StringUtils;
 use Globals;
 use LogHandler;
...
+use Origin\Enum\Order\OrderStatusGroup;
 ...
 use Request;
@@ -7628,7 +7631,10 @@ class OrderAdminNew extends \Component\Order\OrderNew
...
@@ -44,6 +44,9 @@ use Framework\Utility\StringUtils;
 use Globals;
 use LogHandler;
 use Origin\Enum\Order\OrderSettleKind;
+use Origin\Enum\Order\OrderHandleMode;
...
+use Origin\Enum\Order\OrderStatusGroup;
 ...
 use Origin\Service\WebHook\OrderWebHookService;
 use Request;
@@ -7721,7 +7724,10 @@ class OrderAdmin extends \Component\Order\Order
