...
@@ -2572,15 +2572,11 @@ class GoodsAdmin extends \Component\Goods\Goods
...
@@ -2600,18 +2596,15 @@ class GoodsAdmin extends \Component\Goods\Goods
...
@@ -3578,16 +3571,13 @@ class GoodsAdmin extends \Component\Goods\Goods
...
+            // URL 이미지는 변환 대상이 아니므로 'y'로 고정
         ...
         // 상품이미지 > obs 카프카 컨슈머 처리 end
@@ -3808,6 +3798,42 @@ class GoodsAdmin extends \Component\Goods\Goods
         return $fbImageInfo;
     }
...
+
      ...
      * 상품 복사
      *
@@ -3961,28 +3987,6 @@ class GoodsAdmin extends \Component\Goods\Goods
...
@@ -4017,11 +4021,32 @@ class GoodsAdmin extends \Component\Goods\Goods
