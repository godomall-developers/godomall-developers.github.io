...
| A | `Component/RegularDelivery/RegularGoods/RegularGiftSelectCntValidator.php` |
| M | `Component/RegularDelivery/RegularGoods/RegularGoodsChange.php` |
| M | `Component/RegularDelivery/RegularOrder/RegularOrderApplicationCreate.php` |
| M | `Controller/Front/Order/RegularOrderPsController.php` |
| M | `Controller/Mobile/Order/RegularOrderPsController.php` |
| M | `Repository/RegularDelivery/RegularGoods/RegularGiftPresentInfoRepository.php` |
...
### Component/RegularDelivery/RegularGoods/RegularGiftSelectCntValidator.php

```diff
--- /dev/null
+++ b/Component/RegularDelivery/RegularGoods/RegularGiftSelectCntValidator.php
@@ -0,0 +1,79 @@
+<?php
+/*
+ * Copyright (C) 2026 NHN COMMERCE. - All Rights Reserved
...
### Component/RegularDelivery/RegularGoods/RegularGoodsChange.php

```diff
--- a/Component/RegularDelivery/RegularGoods/RegularGoodsChange.php
+++ b/Component/RegularDelivery/RegularGoods/RegularGoodsChange.php
@@ -84,6 +84,9 @@ class RegularGoodsChange
...
@@ -99,7 +102,8 @@ class RegularGoodsChange
...
@@ -118,6 +122,7 @@ class RegularGoodsChange
         $this->logger = $logger;
...
+        $this->regularGiftSelectCntValidator = $regularGiftSelectCntValidator;
     ...
     /**
@@ -145,6 +150,12 @@ class RegularGoodsChange
         // 유효성 검사
...
### Component/RegularDelivery/RegularOrder/RegularOrderApplicationCreate.php

```diff
--- a/Component/RegularDelivery/RegularOrder/RegularOrderApplicationCreate.php
+++ b/Component/RegularDelivery/RegularOrder/RegularOrderApplicationCreate.php
@@ -46,6 +46,7 @@ use Repository\RegularDelivery\RegularOrder\RegularOrderStatusLogRepository;
...
+use Component\RegularDelivery\RegularGoods\RegularGiftSelectCntValidator;
 ...
 /**
  * 정기 결제 신청서 생성
@@ -139,6 +140,11 @@ class RegularOrderApplicationCreate
      */
...
@@ -159,7 +165,8 @@ class RegularOrderApplicationCreate
...
@@ -183,6 +190,7 @@ class RegularOrderApplicationCreate
         $this->logger = $logger;
...
+        $this->regularGiftSelectCntValidator = $regularGiftSelectCntValidator;
     ...
     /**
@@ -519,7 +527,10 @@ class RegularOrderApplicationCreate
             return;
         }
...
### Controller/Front/Order/RegularOrderPsController.php

```diff
--- a/Controller/Front/Order/RegularOrderPsController.php
+++ b/Controller/Front/Order/RegularOrderPsController.php
@@ -15,6 +15,7 @@ use DTO\RegularDelivery\RegularOrder\RegularOrderDTO;
...
+use Framework\Debug\Exception\AlertBackException;
 ...
 use Request;
@@ -56,6 +57,10 @@ class RegularOrderPsController extends Controller
...
### Controller/Mobile/Order/RegularOrderPsController.php

```diff
--- a/Controller/Mobile/Order/RegularOrderPsController.php
+++ b/Controller/Mobile/Order/RegularOrderPsController.php
@@ -15,6 +15,7 @@ use Controller\Mobile\Controller;
...
### Repository/RegularDelivery/RegularGoods/RegularGiftPresentInfoRepository.php

```diff
--- a/Repository/RegularDelivery/RegularGoods/RegularGiftPresentInfoRepository.php
+++ b/Repository/RegularDelivery/RegularGoods/RegularGiftPresentInfoRepository.php
@@ -90,6 +90,32 @@ class RegularGiftPresentInfoRepository
             ->toArray();
     }
