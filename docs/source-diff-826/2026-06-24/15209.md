...
+    const REGISTRATION_FILE_KEY = 'comCertification';
     const ALLOW_MIME_TYPES = [
         'application/pdf',
         'image/jpeg',
@@ -43,64 +46,192 @@ class CompanyCertification
     }
...
@@ -109,17 +240,22 @@ class CompanyCertification
      * 결과 정보 저장
      * @param int $memNo
      * @param array $result
...
@@ -138,6 +274,11 @@ class CompanyCertification
...
+
      ...
      * 사업자 등록증 다운로드
      * @param int $sno
@@ -173,6 +314,20 @@ class CompanyCertification
         }
     }
...
@@ -595,7 +595,20 @@ class MemberAdmin extends \Component\Member\Member
...
+        }
         ...
         //@formatter:on
@@ -638,6 +651,22 @@ class MemberAdmin extends \Component\Member\Member
...
@@ -1339,10 +1340,20 @@ class Member extends \Component\AbstractComponent
...
@@ -1486,10 +1497,17 @@ class Member extends \Component\AbstractComponent
                 $this->benefitJoin($vo);
...
+
         ...
         if ($member['mallSno'] == DEFAULT_MALL_NUMBER) {
@@ -1467,7 +1478,7 @@ class Member extends \Component\AbstractComponent
      *
      * @return int|string
      */
...
@@ -204,16 +206,44 @@ class MyPage extends \Component\AbstractComponent
         if ($result == 1) {
             // 사업자등록증 등록/삭제
...
@@ -322,6 +352,9 @@ class MyPage extends \Component\AbstractComponent
