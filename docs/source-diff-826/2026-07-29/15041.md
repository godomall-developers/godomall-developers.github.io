...
| A | `Controller/Admin/Crm/CrmRecipeClickLogPsController.php` |
...
### Controller/Admin/Crm/CrmRecipeClickLogPsController.php

```diff
--- /dev/null
+++ b/Controller/Admin/Crm/CrmRecipeClickLogPsController.php
@@ -0,0 +1,46 @@
+<?php
+/*
