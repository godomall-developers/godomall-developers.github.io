...
@@ -95,6 +95,35 @@ class GoodsAdmin extends \Component\Goods\Goods
...
+
      ...
      * 생성자
      */
@@ -5248,6 +5277,8 @@ class GoodsAdmin extends \Component\Goods\Goods
...
@@ -6104,21 +6135,30 @@ class GoodsAdmin extends \Component\Goods\Goods
...
+
         ...
         //상품 헤택 모듈
@@ -7071,7 +7111,12 @@ class GoodsAdmin extends \Component\Goods\Goods
         $getValue = Request::get()->toArray();
...
+        }
         ...
         if ($mode == 'restock') {
@@ -11234,6 +11279,9 @@ class GoodsAdmin extends \Component\Goods\Goods
...
@@ -11262,7 +11310,7 @@ class GoodsAdmin extends \Component\Goods\Goods
...
@@ -12316,6 +12364,10 @@ class GoodsAdmin extends \Component\Goods\Goods
...
@@ -12473,6 +12525,10 @@ class GoodsAdmin extends \Component\Goods\Goods
                 $this->db->bind_param_push($arrBind['bind'], 'i', $goodsNo);
                 $this->db->setModDtUse(true);
...
@@ -13094,6 +13150,11 @@ class GoodsAdmin extends \Component\Goods\Goods
             unset($arrBind);
         }
