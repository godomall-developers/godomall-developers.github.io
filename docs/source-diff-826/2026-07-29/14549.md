...
@@ -1948,4 +1948,49 @@ class CategoryAdmin extends \Component\Category\Category
         return $realSetData;
     }
...
@@ -7589,4 +7589,18 @@ class DBTableField
...
@@ -899,6 +899,123 @@ class GoodsAdmin extends \Component\Goods\Goods
         return $getData;
     }
...
+
      ...
      *
@@ -4169,6 +4286,7 @@ class GoodsAdmin extends \Component\Goods\Goods
...
@@ -19,6 +19,7 @@ use Framework\Debug\Exception\LayerException;
...
+use Framework\Security\Token;
 ...
 use Request;
 use Session;
@@ -52,6 +53,35 @@ class GoodsPsController extends \Controller\Admin\Controller
         try {
...
+
                 ...
                 case 'register':
                 case 'modify':
@@ -787,6 +817,42 @@ class GoodsPsController extends \Controller\Admin\Controller
                     exit;
...
@@ -63,7 +63,21 @@ class CategorySelectJsonController  extends \Controller\Admin\Controller
             }
...
+
             ...
             $tmp	= array();
             foreach ($data as $key => $val) {
@@ -78,6 +92,7 @@ class CategorySelectJsonController  extends \Controller\Admin\Controller
