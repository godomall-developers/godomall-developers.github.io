...
@@ -973,6 +974,11 @@ class AdminLogDAO
             $page = '주문 내역 삭제';
         }
...
@@ -501,6 +504,11 @@ class ManagerCs extends \Component\Member\Manager
...
@@ -533,6 +541,7 @@ class ManagerCs extends \Component\Member\Manager
