...
@@ -5854,6 +5854,15 @@ class OrderAdminNew extends \Component\Order\OrderNew
             return false;
         }
...
+
         ...
         foreach ($arrData['statusCheck'] as $val) {
             $bundleData = [];
@@ -7480,6 +7489,11 @@ class OrderAdminNew extends \Component\Order\OrderNew
     {
         // 상품 데이타 존재여부 체크
...
@@ -7727,6 +7741,17 @@ class OrderAdminNew extends \Component\Order\OrderNew
             */
             return true;
         } else {
...
@@ -5927,6 +5927,15 @@ class OrderAdmin extends \Component\Order\Order
             return false;
         }
...
@@ -23,6 +23,7 @@ use Component\Mileage\Mileage;
...
@@ -5287,6 +5288,10 @@ class ReOrderCalculation
...
+
         ...
         if ($count < 1) {
@@ -5326,6 +5331,14 @@ class ReOrderCalculation
...
+
         ...
         $cashFl = false; // 현금영수증
         if ($claimStatus == 'c') {
@@ -5409,6 +5422,76 @@ class ReOrderCalculation
         return true;
     }
...
+
      ...
      * 상품 추가 데이터
@@ -6695,6 +6778,13 @@ class ReOrderCalculation
