...
@@ -261,6 +264,7 @@ class AdminPanelApiController extends \Controller\Admin\Controller
         $indexBoardPanelKey = [
             'noticeAPI',
             'patchAPI',
+            'sellerTipAPI',
...
@@ -268,11 +272,18 @@ class AdminPanelApiController extends \Controller\Admin\Controller
         $cosCategoryMap = [
...
@@ -290,8 +301,10 @@ class AdminPanelApiController extends \Controller\Admin\Controller
