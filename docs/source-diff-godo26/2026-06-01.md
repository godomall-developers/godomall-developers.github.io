...
@@ -2603,7 +2603,7 @@ class GoodsAdmin extends \Component\Goods\Goods
...
@@ -6315,12 +6315,12 @@ class GoodsAdmin extends \Component\Goods\Goods
...
@@ -6920,16 +6920,16 @@ class GoodsAdmin extends \Component\Goods\Goods
...
@@ -6938,7 +6938,7 @@ class GoodsAdmin extends \Component\Goods\Goods
...
@@ -6957,7 +6957,7 @@ class GoodsAdmin extends \Component\Goods\Goods
...
@@ -6976,7 +6976,7 @@ class GoodsAdmin extends \Component\Goods\Goods
                                   SELECT goodsNo
                                   FROM '.$this->goodsTable.'
                                   WHERE delFl = "n" AND applyFl = "y"
...
@@ -6987,7 +6987,7 @@ class GoodsAdmin extends \Component\Goods\Goods
...
+                $strWhere = "goodsNo = '".$this->db->escape($getData['goodsNo'][$k])."' AND cateCd='".$this->db->escape($getData['cateCd'])."'";
                 ...
                 if(is_array($getData['sortFix']) && gd_in_array($getData['goodsNo'][$k],$getData['sortFix'])) {
                     $fixSort = $fixCount;
@@ -7011,7 +7011,7 @@ class GoodsAdmin extends \Component\Goods\Goods
             if($prevSort) {
                 $sortCnt = 0;
...
@@ -7020,7 +7020,7 @@ class GoodsAdmin extends \Component\Goods\Goods
             if($nextSort) {
                 $sortCnt = 0;
...
@@ -7028,7 +7028,7 @@ class GoodsAdmin extends \Component\Goods\Goods
         }
...
@@ -7268,9 +7268,9 @@ class GoodsAdmin extends \Component\Goods\Goods
...
@@ -10779,7 +10779,7 @@ class GoodsAdmin extends \Component\Goods\Goods
...
@@ -10862,7 +10862,7 @@ class GoodsAdmin extends \Component\Goods\Goods
...
+            $totalAmountSQL =  "SELECT COUNT(sno) AS totalCnt FROM " . DB_GOODS_RESTOCK . " WHERE diffKey = '".$this->db->escape($getValue['diffKey'])."'";
             ...
             $page->setPage();
@@ -11134,7 +11134,7 @@ class GoodsAdmin extends \Component\Goods\Goods
     {
