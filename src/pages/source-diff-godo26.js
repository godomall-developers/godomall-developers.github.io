...
export default function SourceDiffGodo26() {
  const data = usePluginData('source-diff-data') ?? {};
  const dates = data.godo26 ?? [];

  return (
    <Layout title="소스 diff (GODO 26)" description="GODO 26 소스 변경 내역">
          ...
          <div className="ncua-page-title__header ncua-page-title__header--has-breadcrumb">
            <div className="ncua-page-title__container">
              <nav className="ncua-page-title__breadcrumb" aria-label="breadcrumb">
                ...
                <span className="ncua-page-title__breadcrumb-current">소스 diff (GODO 26)</span>
              </nav>
              <div className="ncua-page-title__title-row">
                <h1 className="ncua-page-title__title">소스 diff (GODO 26)</h1>
              </div>
            </div>
          </div>
        </div>
