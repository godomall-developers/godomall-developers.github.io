...
export default function SourceDiff825() {
  const data = usePluginData('source-diff-data') ?? {};
  const dates = data['825'] ?? [];

  return (
    <Layout title="소스 diff (PHP 8 · GODO25)" description="PHP 8 · GODO25 소스 변경 내역">
          ...
          <div className="ncua-page-title__header ncua-page-title__header--has-breadcrumb">
            <div className="ncua-page-title__container">
              <nav className="ncua-page-title__breadcrumb" aria-label="breadcrumb">
                ...
                <span className="ncua-page-title__breadcrumb-current">소스 diff (PHP 8 · GODO25)</span>
              </nav>
              <div className="ncua-page-title__title-row">
                <h1 className="ncua-page-title__title">소스 diff (PHP 8 · GODO25)</h1>
              </div>
            </div>
          </div>
        </div>
