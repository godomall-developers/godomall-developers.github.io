...
export default function SourceDiff826() {
  const data = usePluginData('source-diff-data') ?? {};
  const dates = data['826'] ?? [];

  return (
    <Layout title="소스 diff (PHP 8 · GODO26)" description="PHP 8 · GODO26 소스 변경 내역">
          ...
          <div className="ncua-page-title__header ncua-page-title__header--has-breadcrumb">
            <div className="ncua-page-title__container">
              <nav className="ncua-page-title__breadcrumb" aria-label="breadcrumb">
                ...
                <span className="ncua-page-title__breadcrumb-current">소스 diff (PHP 8 · GODO26)</span>
              </nav>
              <div className="ncua-page-title__title-row">
                <h1 className="ncua-page-title__title">소스 diff (PHP 8 · GODO26)</h1>
              </div>
            </div>
          </div>
        </div>
